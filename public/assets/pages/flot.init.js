...
!function($) {
    ...
    FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
        ...
        FlotChart.prototype.init = function() {
          ...
          var datas = [20,30, 15];
          var colors = ['rgba(43, 58, 74, 1)', 'rgba(65, 186, 194, 1)', 'rgba(238, 240, 246, 1)'];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#365d6e']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutwidth = [50];
          var donutcolors = ['rgba(43, 58, 74, 1)', 'rgba(65, 186, 194, 1)', 'rgba(238, 240, 246, 1)'];         
