function init_parent_section() {
    ...
    html +=                      '<div class="col-md-7 col-sm-7 col-xs-12">';
    html +=                          '<button type="button" class="btn btn-outline-dark btn-block" onclick="add_section_element();">Add Section Element</button>';
    html +=                      '</div>';
    html +=                  '</div>';
    html +=              '</div>';

    // =================== DROP SECTION ELEMENT HERE ===================
    html +=             '<div id="drop-section-element"></div>';
    // =================== DROP SECTION ELEMENT HERE ===================
...
function init_section_element() {
    ...
    html +=                     '<label class="col-md-3 col-sm-3 col-xs-12 input-left"></label>';
    html +=                     '<div class="col-md-7 col-sm-7 col-xs-12">';
    html +=                         '<button type="button" class="btn btn-outline-dark btn-block" onclick="add_section_item()">Add Item</button>';
    html +=                     '</div>';
    html +=                 '</div>';
    ...
    $('#drop-section-element').append(html);
}
...
function init_item_masterhead() {
    ...
    html +=                 '</div>';
                            ...
                            // ON IMAGE - TITLE
    html +=                 '<div class="form-group row">';
    html +=                     '<label class="col-md-3 col-sm-3 col-xs-12 input-left" for="title">On-Image Title </label>';
    html +=                     '<div class="col-md-7 col-sm-7 col-xs-12">';
    html +=                         '<input type="text" class="form-control col-md-12 col-xs-12" name="on_image_title">';
    html +=                     '</div>';
    html +=                 '</div>';
    ...
    html +=                     '<label class="col-md-3 col-sm-3 col-xs-12 input-left" for="title">On-Image Title </label>';
    html +=                     '<div class="col-md-7 col-sm-7 col-xs-12">';
    html +=                          '<textarea name="on_image_subtitle" id="on_image_subtitle" rows="3" class="form-control col-md-12 col-xs-12"></textarea>';
    html +=                     '</div>';
    html +=                 '</div>';

                            // SECTION WIDTH -> 1 TO 12
    html +=                 '<div class="form-group row">';
    ...
    html +=                 '<hr>';
                            ...
                            // BUTTON A
    html +=                 '<div class="form-group row">';
    html +=                     '<label class="col-md-3 col-sm-3 col-xs-12 input-left" for="align">Button A - Link Type</label>';
    html +=                     '<div class="col-md-7 col-sm-7 col-xs-12">';
    html +=                         '<select class="select2 form-control" id="button_a_link_type" name="button_a_link_type" onchange="show_input_link(this.value)">';
    html +=                             '<option selected disabled>- Please Choose One -</option>';
    html +=                             '<option value="">No Link</option>';
